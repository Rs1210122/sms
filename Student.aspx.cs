...
public partial class Student : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "Update student set fname='" + TextBox2.Text + "',lname='" + TextBox3.Text + "',dob='" + TextBox4.Text + "',phone='" + TextBox5.Text + "',mobile='" + TextBox6.Text + "',status='" + TextBox7.Text + "',parent_id='" + TextBox8.Text + "',date_of_join='" + TextBox9.Text + "' where student_id='" + TextBox1.Text + "'";
            cmd.ExecuteNonQuery();
